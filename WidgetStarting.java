...
****************************************/
public class WidgetStarting implements Comparable<WidgetStarting>
{
  // fields
   private int myCubits, myHands;
   
  // constructors
   public WidgetStarting()
   {
      myCubits = myHands = 0;
   }
   public WidgetStarting(int x)
   {
      myCubits = x;
      myHands = 0;
   }
   public WidgetStarting(int x, int y)
   {
      myCubits = x;
      myHands = y;
   }
   public WidgetStarting(Widget arg)
   {
   ...
   public void setHands(int x)
   {
      myHands = x;
   	...
   	//other methods
   public int compareTo(WidgetStarting other)
   {
   ...
   public boolean equals(WidgetStarting other)    //not equals(Object arg)
   {
   ...
   {
      return equals((WidgetStarting)arg );
   }
   public int hashCode()
   {
